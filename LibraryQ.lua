...
function Quantum:CreateWindow(data)
    ...
    local ConfirmNo = Create("TextButton", {
        Parent = ConfirmBox,
        Size = UDim2.new(0, 76, 0, 24),
        Position = UDim2.new(0.5, -82, 1, -32),
        BackgroundColor3 = CurrentTheme.Element,
        Text = "Cancel",
        TextColor3 = CurrentTheme.Text,
        TextSize = 8,
    ...
    local Controls = Create("Frame", {
        Name = "Controls",
        Parent = Topbar,
        Size = UDim2.new(0, 80, 0, Config.TopbarHeight),
        ...
        function TabAPI:CreateSection(sectionData)
            ...
            function SectionAPI:CreateToggle(toggleData)
                ...
                Create("ImageLabel", {
                    Parent = ToggleFrame,
                    Size = UDim2.new(0, 6, 0, 6),
                    Position = UDim2.new(0, 8, 0, hasDesc and 6 or 8),
                    BackgroundTransparency = 1,
                ...
                Create("TextLabel", {
                    ...
                    Position = UDim2.new(0, 24, 0, hasDesc and 2 or 5),
                    BackgroundTransparency = 1,
                    Text = toggleName,
                    TextColor3 = CurrentTheme.Text,
                    TextSize = 8,
            ...
            function SectionAPI:CreateSlider(sliderData)
                ...
                Create("ImageLabel", {
                    Parent = SliderFrame,
                    Size = UDim2.new(0, 6, 0, 6),
                    Position = UDim2.new(0, 8, 0, hasDesc and 6 or 6),
                    BackgroundTransparency = 1,
                ...
                Create("TextLabel", {
                    ...
                    Position = UDim2.new(0, 24, 0, hasDesc and 2 or 4),
                    BackgroundTransparency = 1,
                    Text = sliderName,
                    TextColor3 = CurrentTheme.Text,
                    TextSize = 8,
                ...
                local ValueLabel = Create("TextLabel", {
                    ...
                    Position = UDim2.new(1, -46, 0, hasDesc and 2 or 4),
                    BackgroundTransparency = 1,
            ...
            function SectionAPI:CreateButton(buttonData)
                ...
                local hasDesc = desc and desc ~= ""
                local frameHeight = hasDesc and 36 or 24
            ...
            function SectionAPI:CreateDropdown(dropdownData)
                ...
                local DropdownBtn = Create("TextButton", {
                    ...
                    Position = UDim2.new(1, -108, 0, hasDesc and 8 or 3),
                    BackgroundColor3 = CurrentTheme.Element,
                    Text = "",
                    TextColor3 = CurrentTheme.SubText,
                    TextSize = 8,
                ...
                local function BuildOptions(filterText)
                    ...
                    local listHeight = math.min(count * 18 + 4, 100)
                    OptionsScroll.Size = UDim2.new(1, -10, 0, listHeight)
                    OptionsScroll.CanvasSize = UDim2.new(0, 0, 0, count * 18 + 4)
                end
                ...
                DropdownBtn.MouseButton1Click:Connect(function()
                    if ddData.IsOpen then
                        ...
                        local menuHeight = math.min(#options * 18 + 34, 150)
            ...
            function SectionAPI:CreateInput(inputData)
                ...
                local InputBox = Create("TextBox", {
                    Parent = InputFrame,
                    Size = UDim2.new(0, 100, 0, 18),
                    Position = UDim2.new(1, -108, 0, hasDesc and 8 or 4),
                    BackgroundColor3 = CurrentTheme.Element,
                    Text = default,
            ...
            function SectionAPI:CreateKeybind(bindData)
                ...
                local BindBtn = Create("TextButton", {
                    ...
                    Position = UDim2.new(1, -58, 0, hasDesc and 8 or 4),
                    BackgroundColor3 = CurrentTheme.Element,
                    Text = default.Name,
                    TextColor3 = CurrentTheme.Text,
                    TextSize = 8,
            ...
            function SectionAPI:CreateParagraph(paraData)
                ...
                local function RefreshSize()
                    ...
                    if width > 0 then
                        ...
                        local newHeight = 22 + bounds.Y + 10
            ...
            function SectionAPI:CreateColorPicker(pickerData)
                ...
                local ColorPreview = Create("TextButton", {
                    ...
                    Position = UDim2.new(1, -44, 0, hasDesc and 8 or 4),
                ...
                ColorPreview.MouseButton1Click:Connect(function()
                    ...
                    if colorOpen then
                        ...
                        ColorMenu.Size = UDim2.new(0, 110, 0, 48)
                    else
